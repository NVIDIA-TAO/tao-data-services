...
"""Unit tests for dual logging functionality in TAO Data Services."""
...
from nvidia_tao_ds.core.logging.logging import logging, logger, StatusLoggerHandler, StatusLogger, set_status_logger, get_status_logger
...
def test_dual_logging_writes_to_both_outputs(temp_log_dir, reset_logger, monkeypatch):
    ...
    from nvidia_tao_ds.core.logging.logging import get_logging_level
