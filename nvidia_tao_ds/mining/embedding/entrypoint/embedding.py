...
"""Define entrypoint to run tasks for embeddings."""

import argparse

from nvidia_tao_ds.mining.embedding import scripts
...
def main():
    ...
    launch(vars(args), unknown_args, subtasks, network="embedding")
